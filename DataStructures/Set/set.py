...
def get_first_element(my_set):
    """Obtiene el primer elemento del set

    :param my_set: Set del que se obtendra el primer elemento
    :type my_set: set

    :returns: Primer elemento del set
    :rtype: any
    """
    if my_set['size'] > 0:
...
def get_last_element(my_set):
    """Obtiene el último elemento del set

    :param my_set: Set del que se obtendra el último elemento
    :type my_set: set

    :returns: Último elemento del set
    :rtype: any
    """
    if my_set['size'] > 0:
